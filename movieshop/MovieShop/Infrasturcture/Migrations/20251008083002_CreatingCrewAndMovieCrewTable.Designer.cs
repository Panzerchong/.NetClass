...
namespace Infrasturcture.Migrations
{
    ...
    [Migration("20251008083002_CreatingCrewAndMovieCrewTable")]
    partial class CreatingCrewAndMovieCrewTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ApplicationCore.Entities.MovieCast", b =>
                {
                    ...
                    b.HasIndex("MovieCastMovieId", "MovieCastCastId");
            ...
            modelBuilder.Entity("ApplicationCore.Entities.MovieCast", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.MovieCast", null)
                        .WithMany("MoviesOfCast")
                        .HasForeignKey("MovieCastMovieId", "MovieCastCastId");
